    ...
    return (
        <div className='border w-screen h-screen relative flex items-center justify-center'>
            ...
            <form onSubmit={signupUser} className='w-96  bg-amber-50 rounded-xl shadow-md p-5' action="" method="get">
                ...
                <button className='text-center px-4 py-1.5 shadow-lg bg-[#2563EB] text-white font-semibold rounded-md my-4 cursor-pointer hover:text-[#2563EB] hover:bg-white hover:border-[#2563EB]'>SignUp</button>
